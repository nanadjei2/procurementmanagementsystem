                        ...
                        <div class="row m-b-40">
                            ...
                            <div class="col-xs-12 col-xl-6">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-xl-6">
                                        <div class="m-b-20">
                                            <div class="text-widget-7 bg-warning-700 color-white">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="amount text-left">$2,446</div>
                                                        <div class="title text-left">Store revenue</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-xl-6">
                                        <div class="m-b-20">
                                            <div class="text-widget-7 bg-success color-white">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="amount text-right">$12,541</div>
                                                        <div class="title text-right">Online sales</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-xl-6">
                                        <div class="m-b-20">
                                            <div class="text-widget-7 bg-danger color-white">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="amount text-left">$5,430</div>
                                                        <div class="title text-left">Profit</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-xl-6">
                                        <div class="m-b-20">
                                            <div class="text-widget-7 bg-info color-white">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="amount text-right">$1,433</div>
                                                        <div class="title text-right">Ad revenue</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <div class="dropdown pull-right m-0">
                                            ...
                                            <a href="index-2.html#" class="btn no-bg dropdown-toggle no-after" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-775">
                                            <i class="fa fa-cog" id="icon-775"></i> 
                                        </button>
                                    </div>
                                </div>
                                <div class="timeline-widget-10">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="p-10 p-l-40 timeline timeline-danger">
                                                <div class="text">Finished integration tests</div>
                            ...
                            <div class="col-xs-12 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-124">
                                            <i class="fa fa-cog" id="icon-124"></i> 
                                        </button>
                                    </div>
                                </div>
                                <div class="user-widget-8">
                            ...
                            <div class="col-xs-12 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-493">
                                            <i class="fa fa-cog" id="icon-493"></i> 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-752">
                                            <i class="fa fa-cog" id="icon-752"></i> 
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-78">
                                            <i class="fa fa-cog" id="icon-78"></i> 
                                        </button>
                                    </div>
                                </div>
                                <canvas id="analytics-area-chart" style="width:100%; height: 250px"></canvas>
                            </div>
                            <div class="col-xs-12 col-lg-4">
                                <div class="row">
                                    <div class="col-xs-7">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-121">
                                            <i class="fa fa-cog" id="icon-121"></i> 
                                        </button>
                                    </div>
                                </div>
                                <canvas id="analytics-bar-chart" style="width:100%; height: 250px"></canvas>
                            </div>
                        </div>
                        <div class="row m-b-20">
                            <div class="col-xs-12 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-700">
                                            <i class="fa fa-cog" id="icon-700"></i> 
                                        </button>
                                    </div>
                                </div>
                                <div class="p-t-20">
                            ...
                            <div class="col-xs-12 col-lg-4">
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        ...
                                        <button class="btn no-bg pull-right m-0" data-animate="icon-772">
                                            <i class="fa fa-cog" id="icon-772"></i> 
                                        </button>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-lg-6">
                                        <ul class="list-unstyled">
                                            <li>
                                                <span class="label label-success label-rounded color-white">A</span> 
                                                <span>USA</span> 
                                            </li>
                                            <li>
                                                <span class="label label-warning label-rounded color-white">B</span> 
                                                <span>Canada</span> 
                                            </li>
                                            <li>
                                                <span class="label label-danger label-rounded color-white">C</span> 
                                                <span>Mexico</span> 
                                            </li>
                                            <li>
                                                <span class="label label-info label-rounded color-white">D</span> 
                                                <span>Argentina</span> 
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <span class="fa-stack fa-stack-2x pull-left">
                                                        ...
                                                        <i class="fa fa fa-heart fa-stack-1x color-danger"></i>
                                                    </span> 
                                                </div>
                                                <div class="col-xs-8 text-left">
                                                    <div class="row">
                                    ...
                                    <div class="text-widget-5">
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <span class="fa-stack fa-stack-2x pull-left">
                                                    <i class="fa fa-circle fa-stack-2x color-white"></i>
                                                    <i class="fa fa fa-camera fa-stack-1x color-success"></i>
                                                </span> 
                                            </div>
                                            <div class="col-xs-8 text-left">
                                                <div class="row">
                                ...
                                <div class="text-widget-5">
                                    <div class="row">
                                        <div class="col-xs-4">
                                            <span class="fa-stack fa-stack-2x pull-left">
                                                <i class="fa fa-circle fa-stack-2x color-white"></i>
                                                <i class="fa fa fa-commenting fa-stack-1x color-warning"></i>
                                            </span> 
                                        </div>
                                        <div class="col-xs-8 text-left">
                                            <div class="row">
                            ...
                            <div class="icon-widget-3 bg-twitter">
                                <div class="row icons">
                                    <div class="col-xs-12 col-lg-4 text-center">
                                        <div class="amount">
                                            <i class="fa fa-heart-o color-white"></i> 
                                            <span class="color-white">63</span> 
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-lg-4 text-center">
                                        <div class="amount">
                                            <i class="fa fa-comment-o color-white"></i> 
                                            <span class="color-white">70</span> 
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-lg-4 text-center">
                                        <div class="amount">
                                            <i class="fa fa-star-o color-white"></i> 
                                            <span class="color-white">30</span> 
                                        </div>
                                    </div>
                                </div>
                            </div>
